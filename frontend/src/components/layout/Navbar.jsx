...
export const Navbar = () => {
  ...
  return (
    <nav className={`sticky top-0 z-50 w-full border-b border-border-main ${theme === 'glassmorphic' ? 'glass border-none' : 'bg-base-surface'}`}>
      <div className="container mx-auto max-w-4xl px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 text-xl font-bold tracking-tight text-accent-main hover:opacity-80 transition-opacity">
